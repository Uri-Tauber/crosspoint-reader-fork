...
void JPEGDEC::setFramebuffer(void* pFramebuffer) { JPEG_setFramebuffer(&_jpeg, pFramebuffer); } /* setFramebuffer() */
...
int JPEGDEC::getOrientation() { return (int)_jpeg.ucOrientation; } /* getOrientation() */
...
int JPEGDEC::getThumbHeight() { return _jpeg.iThumbHeight; } /* getThumbHeight() */

int JPEGDEC::getBpp() { return (int)_jpeg.ucBpp; } /* getBpp() */

int JPEGDEC::getSubSample() { return (int)_jpeg.ucSubSample; } /* getSubSample() */

void JPEGDEC::setCropArea(int x, int y, int w, int h) { JPEG_setCropArea(&_jpeg, x, y, w, h); } /* setCropArea() */

void JPEGDEC::getCropArea(int* x, int* y, int* w, int* h) { JPEG_getCropArea(&_jpeg, x, y, w, h); } /* getCropArea() */
...
static int32_t FileSeek(JPEGFILE* handle, int32_t position) { return ((File*)(handle->fHandle))->seek(position); }
